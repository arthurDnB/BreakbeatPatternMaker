...
export const V3_RULES:Record<Genre,V3Rule>={
 ...
 amenscience:rule('jungle',{snareMotifs:[[4,12],[4,10,14],[4,12,15]],kicks:[[0,6,10],[0,3,10,14],[0,6,10,15]],hats:[0,2,4,6,8,10,12,14],hatDetails:[1,3,5,7,9,11,13,15],ghosts:[3,7,9,11,14,15],percussion:[2,5,13],pickups:[2,9,14],activity:.95,ghostGain:.4,fillStrength:1,burstBudget:4,maxRepeats:8,reverseChance:.3,pitchSteps:[0,7,12,-12,-5]}),
 atmosphericbreakcore:rule('experimental',{kicks:[[0,6,10],[0,3,10,14],[0,7,10]],hats:[0,2,4,6,8,10,12,14],hatDetails:[1,3,5,7,9,11,13,15],ghosts:[2,3,7,9,11,14,15],percussion:[1,5,13],pickups:[7,14],snareDragMs:2,activity:.88,ghostGain:.35,spaciousCall:true,melodicPercussion:true,euclidean:undefined,cadence:'jungle',fillStrength:.95,burstBudget:3,maxRepeats:8,reverseChance:.2,pitchSteps:[0,7,12,-12]}),
